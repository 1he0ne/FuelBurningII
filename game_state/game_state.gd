...
@onready var EXPECTED_FPS := 60.0#ProjectSettings.get_setting("physics/common/physics_fps")
...
@onready var DEFAULT_BOMB_COUNT := 1.0
@onready var DEFAULT_EXTRA_LIVES := 3.0
